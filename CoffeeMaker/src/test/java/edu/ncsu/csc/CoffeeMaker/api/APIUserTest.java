...
class APIUserTest {
	...
	public void testGetUser() throws Exception {
		...
		mvc.perform(get(String.format("/api/v1/users/%s", "staff"))).andDo(print()).andExpect(status().isNotFound());
	}
	...
	public void testDeleteUser() throws Exception {
		...
		mvc.perform(delete(String.format("/api/v1/users/%s", "customer1")).contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void testLogin() throws Exception {
		...
		mvc.perform(
				get("/api/v1/users").contentType(MediaType.APPLICATION_JSON).content(TestUtils.asJsonString(customer)))
				.andExpect(status().isOk());
	}
