...
public class CustomerOrder extends DomainObject {
	...
	/**
	 * Represents the username identifier for a Order object, must be between 6 and
	 * 20 characters
	 */
	@Length(min = 6, max = 20)
	...
	/**
	 * Creates a default customerorder for the CoffeeMaker system. Used by Hibernate
	 */
	public CustomerOrder() {
		super();
	 ...
	 *
	 * @param name             represents name of CustomerOrder object
	 * @param customerUsername username of customer for CustomerOrder object
	 * @param beverages        list of recipes in CustomerOrder object
	 */
	 ...
	 *
	 * @param customerUsername customer's username associated with the order
	 */
	 ...
	 *
	 * @param inv Inventory to be looked at
	 */
