...
public class Recipe extends DomainObject {
     ...
     *
     * @param ingredients
     *            List of Ingredient objects to represent the ingredients that
     *            make up a recipe
     * @param price
     *            Integer representing the price of a recipe
     */
    ...
    // /*
    // * Edits the specified recipe with provided price and ingredients. Users
    // can
    ...
    // *
    // * @param ingredients represents updated list of ingredients with,
    // potentially,
    // * new units
    // */
    // public void editRecipe(final Integer price, final List<Ingredient>
    // ingredients) {
     ...
     *
     * @param newRecipe
     *            represent Recipe object with updated price and list of
     *            Ingredient objects
     */
    ...
    /**
     * Returns a specific Ingredient object amount from the Recipe based on the
     * name of the ingredient or 0 if the Ingredient doesn't exist in the Recipe
     *
     * @param name
     *            represents name of Ingredient object to return
     * @return Ingredient amount from Recipe based on provided Ingredient name
     *         or 0 if Ingredient doesn't exist
     */
     ...
     *
     * @param name
     *            represents name of Ingredient object in Recipe to update
     * @param amount
