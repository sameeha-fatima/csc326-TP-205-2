...
public class APIUserController extends APIController {
     ...
     *
     * @param id
     *            represents the user ID / username used to find a user from the
     *            database
     ...
     *         the CoffeeMaker system, or an error if it could not be
     */
     ...
     *
     * @param user
     *            represents user to search for in the CoffeeMaker system
     * @return User object with 200 status if successful login or an error
     *         response (400) if not
     */
